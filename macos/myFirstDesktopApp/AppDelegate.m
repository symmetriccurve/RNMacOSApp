...
-(id)init
{
    if(self = [super init]) {
        ...
        [windowController setWindowFrameAutosaveName:@"myFirstDesktopApp"];
...
- (void)setUpApplicationMenu
{
    ...
    [rootMenu addItemWithTitle:@"Quit myFirstDesktopApp" action:@selector(terminate:) keyEquivalent:@"q"];
